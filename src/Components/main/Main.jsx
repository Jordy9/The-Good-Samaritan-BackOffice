...
export const Main = () => {
    ...
    const hanldedSubmit = (e) => {
        ...
        if (title.trim().length > 3 && descripcion.trim().length > 3) {
            dispatch(startCreateMain(title, descripcion, fileupload))
        } else {
            ...
            <div className = 'row'>
                ...
                <div className="col-6">
                    <div>
                        ...
                        <input type="text" className='form-control' placeholder='Dios ha sido bueono' value={descripcion} onChange={handledInputChange} name='descripcion' />
                    </div>
                </div>
            </div>
