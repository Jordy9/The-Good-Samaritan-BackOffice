...
export const EventModal = () => {
    ...
    const [HandledInputChange, Value] = useForm(activeEvent)
    ...
    const hanldedSubmit = (e) => {
        ...
        dispatch(startUpdateEvento(title, date, state, fileupload))
    }
                                    ...
                                    <form onSubmit = {hanldedSubmit} className = 'needs-validation'>
                                        <div className="row">
                                            <div className="col form-group">
                                                <label>Título</label>
                                                <input name = 'title' type="text" onChange = {HandledInputChange} value = {title || activeEvent.title} placeholder = 'El amor del Señor' className = 'form-control bg-transparent text-white' />
                                            </div>

                                            <div className="col form-group">
                                                <label>Fecha</label>
                                                <input name = 'date' type="date" onChange = {HandledInputChange} value = {date || activeEvent.date} className = 'form-control bg-transparent text-white' />
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-12">
                                                <div>
                                                    <Editor
                                                        ...
                                                        value = {state || activeEvent.descripcion}
