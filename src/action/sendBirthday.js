...
export const sendBirthday = (content, user) => {
    return async(dispatch, getState) => {
        ...
        const title = '¡Te deseamos lo mejor!'
...
<meta content="text/html;charset=UTF-8" http-equiv="Content-Type"></head><body bgcolor="#020203" style="margin:0; padding:0;font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#000000;"><center> 
<div class="zppage-container">                                                          
		<table bgcolor="#020203" border="0" cellpadding="0" cellspacing="0" class="contentOuter" id="contentOuter" style="background-color:#f0f0f0;background-color:#020203;font-size:12px;text-align:center;border:0px;padding:0px;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="100%"> 
			<tbody><tr> 
				...
				<td align="center" style="border:0px;padding:0px;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<table bgcolor="#020202" border="0" cellpadding="0" cellspacing="0" class="contentInner" id="contentInner" style="border-collapse:collapse; border:0px;font-size:12px;background-color:#ffffff;background-color:#020202;width:600px;margin:0px auto;border:0px;" width="600"> 
					<tbody><tr> 
...
<tr><td class="txtsize" id="elm_1604484219453" style="border:0px;padding:0px 0px;border-collapse:collapse;" valign="top">
		...
		<td class="txtsize" style="border:0px;padding:0px 0px;border-top:none none none ;border-bottom:none none none;">
			...
			<img align="center" alt="https://campaign-image.com/zohocampaigns/174213000013650240_zc_v30_1604568465875_welcome26_banner.png" class="zpImage" height="300" hspace="0" size="C" src="https://campaign-image.com/zohocampaigns/954164000000042304_zc_v21_1652793320028_logo_ccbs_solo_color.png" style="width:300px;height:300px;max-width:300px !important;border:0px;text-align:center;" vspace="0" width="300">
			</a>
			</td></tr>
...
<tr><td class="txtsize" id="elm_1604562712323" style="border:0px;padding:0px 0px;border-collapse:collapse;" valign="top">
          ...
          <div class="zpelement-wrapper" id="elm_1604562712323" style=";word-wrap:break-word;overflow:hidden;padding-right:0px;background-color:#15212f;">
            ...
            <tbody><tr><td class="paddingcomp" style="border:0px;padding:7px 15px;line-height:19pt;border-top:0px none ;   border-bottom:0px none ;padding-top:9px;padding-bottom:9px;padding-right:90px;padding-left:25px;">
             	    		<div componentbgcolor="#15212f" componentpaddingbottom="9px" componentpaddingleft="25px" componentpaddingright="90px" componentpaddingtop="9px" data-darkreader-inline-bgcolor style="background-color: rgb(21, 33, 47); --darkreader-inline-bgcolor:#111a26;"><p align="left" style="font-family:Arial,verdana;font-size:12px; color:#000000;padding:0px;margin: 0;line-height: 19pt; text-align: left;"><font color="#c5c0b8" data-darkreader-inline-color style="--darkreader-inline-color:#bfbab1;"><font face="Arial, Helvetica" style><span style="font-size: 16px;">De parte de todo el equipo de ccbsbonao te d</span></font><span data-darkreader-inline-bgcolor style="font-size: 16px; font-family: Arial, Helvetica; background-color: rgb(21, 33, 47); --darkreader-inline-bgcolor:#111a26;">eseamos un feliz cumplea&ntilde;os.</span></font></p></div>
			</td></tr>
		</tbody></table>
       	  </div>
</td></tr>
